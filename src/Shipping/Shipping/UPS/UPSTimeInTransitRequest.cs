...
namespace Spring2.Core.Shipping.UPS {
    class UPSTimeInTransitRequest : ITimeInTransitRequest {
        ...
        public UPSTimeInTransitRequest(ArtifactAddressData fromLocation, ArtifactAddressData toLocation, DateTimeType pickupDateTime, DecimalType shipmentWeight, StringType unitOfMeasurment, StringType currencyCode, CurrencyType monetaryValue) {
        ...
        public StringType UnitOfMeasurment {
        ...
        public string GetRequestXml(ArtifactAddressData fromLocation, ArtifactAddressData toLocation, DateTimeType pickupDateTime, DecimalType shipmentWeight, StringType unitOfMeasurment, StringType currencyCode, CurrencyType monetaryValue) {
            this.fromLocation = fromLocation;
            this.toLocation = toLocation;
            this.pickupDateTime = pickupDateTime;
            this.shipmentWeight = shipmentWeight;
        ...
        public string GetRequestXml() {
            ...
            buffer.Append(@"<CurrencyCode>" + currencyCode.ToString() + "</CurrencyCode>" + Environment.NewLine);
            ...
            buffer.Append(@"<Code>" + unitOfMeasurment.ToString() + "</Code>" + Environment.NewLine);
            buffer.Append(@"<Description>" + "" + "</Description>" + Environment.NewLine);
            buffer.Append(@"</UnitOfMeasurement>" + Environment.NewLine);
