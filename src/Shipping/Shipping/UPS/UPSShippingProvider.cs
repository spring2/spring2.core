...
namespace Spring2.Core.Shipping.UPS {
    class UPSShippingProvider : IShippingProvider {
            ...
            public ITimeInTransitResponse TimeInTransit(ArtifactAddressData fromLocation, ArtifactAddressData toLocation, DateTimeType pickupDateTime, DecimalType shipmentWeight, StringType unitOfMeasurment, StringType currencyCode, CurrencyType monetaryValue) {
