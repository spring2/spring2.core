...
namespace Spring2.Core.Test.Serialization {
	...
	public class ValueObject : DataObject.DataObject {
	    private DecimalType _valid = new DecimalType(1);
	    private DecimalType _unset = DecimalType.UNSET;
	    private DecimalType _default = DecimalType.DEFAULT;

	    public DecimalType Valid {
		get { return _valid; }
		set { _valid = value; }
	    }

	    public DecimalType Unset {
		get { return _unset; }
		set { _unset = value; }
	    }
	...
	public void ShouldBinarySerializeWithValue() {
	    DecimalType s = new DecimalType(1);
	    DecimalType s2 = (DecimalType)SerializeDeserialze(s);
	...
	public void ShouldBinarySerializeUnset() {
	    DecimalType s = DecimalType.UNSET;
	    DecimalType s2 = (DecimalType)SerializeDeserialze(s);
	...
	public void ShouldBinarySerializeDefault() {
	    DecimalType s = DecimalType.DEFAULT;
	    DecimalType s2 = (DecimalType)SerializeDeserialze(s);
