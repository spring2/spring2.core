...
namespace Spring2.Core.PostageService.Stamps {
	...
	static StampsModelAssembler() {
		...
		.ForMember(x => x.To, o => o.MapFrom(src => new SWSIMV52.Address() {
		    ...
		    ZIPCode = (src.CustomsInfo != null && !String.IsNullOrWhiteSpace(src.CustomsInfo.ContentsType)) ? null : src.ToPostalCode,
		    State = (src.CustomsInfo != null && !String.IsNullOrWhiteSpace(src.CustomsInfo.ContentsType)) ? null : src.ToState,
